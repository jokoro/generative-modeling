...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        self.fc = nn.Linear(256*int(self.input_shape[-1]**2)//64, self.latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        # 2*self.latent_dim
        ##################################################################
        input_size = torch.tensor(self.input_shape).prod()
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim, output_shape):
        ...
        self.base_size = (
            ...
            self.output_shape[2]//8,
        )
        self.fc = nn.Linear(self.latent_dim, torch.tensor(self.base_size).prod())
